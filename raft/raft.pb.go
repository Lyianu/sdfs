...
type RegisterMasterResponse struct {
	...
	ConnectId int32 `protobuf:"varint,3,opt,name=connectId,proto3" json:"connectId,omitempty"` // the id of the server being connected to
}
...
func (x *RegisterMasterResponse) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_raft_raft_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x22, 0x60, 0x0a, 0x16, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x63,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x49, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09,
