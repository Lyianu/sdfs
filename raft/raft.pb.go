...
type GetPeerListResponse struct {
	...
	PeerIds   []uint64 `protobuf:"varint,1,rep,packed,name=peerIds,proto3" json:"peerIds,omitempty"`
	PeerAddrs []string `protobuf:"bytes,2,rep,name=peerAddrs,proto3" json:"peerAddrs,omitempty"`
}
...
func (x *GetPeerListResponse) GetPeerIds() []uint64 {
	if x != nil {
		return x.PeerIds
	}
	return nil
...
func (x *GetPeerListResponse) GetPeerAddrs() []string {
	if x != nil {
		return x.PeerAddrs
	}
	return nil
...
var file_raft_raft_proto_rawDesc = []byte{
	...
	0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x22, 0x4d, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x70,
	0x65, 0x65, 0x72, 0x49, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x07, 0x70, 0x65,
	0x65, 0x72, 0x49, 0x64, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x65, 0x65, 0x72, 0x41, 0x64, 0x64,
	0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x70, 0x65, 0x65, 0x72, 0x41, 0x64,
	0x64, 0x72, 0x73, 0x32, 0xc0, 0x01, 0x0a, 0x04, 0x52, 0x61, 0x66, 0x74, 0x12, 0x3a, 0x0a, 0x0b,
	...
	0x74, 0x50, 0x65, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x13, 0x2e, 0x47, 0x65, 0x74, 0x50,
	0x65, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14,
	0x2e, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x72, 0x61, 0x66, 0x74,
...
var file_raft_raft_proto_goTypes = []interface{}{
	...
	(*Entry)(nil),                 // 4: Entry
	(*GetPeerListRequest)(nil),    // 5: GetPeerListRequest
	(*GetPeerListResponse)(nil),   // 6: GetPeerListResponse
}
...
func file_raft_raft_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_raft_raft_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPeerListRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_raft_raft_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPeerListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
